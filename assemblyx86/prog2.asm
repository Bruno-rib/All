...
;					*There were a lot details in each sentence of the assigment and to make sure I covered every detail it took 
;							me a while to read as I was doing the program. I am also not very familiar yet with asm programs 
;							so to make sure it would compile I went back and forth using the examples on the website.
...
main PROC
    ...
    ;section containing first part of printed equation to console
    ...
    ;performing the following operation and printing variables and result as we go:
	;num1 + num2 * num3 % (num4 - num5) / num6 ^ 2 - num7
